      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/45">
            Weekly space lease / rental
          </h2>
          <p className="mt-1 max-w-2xl text-xs text-white/40">
            Booth and chair rent from stylists — operating revenue, separate from retail gross profit and service
            revenue.
          </p>
        </div>
      ...
      {canManage ? (
        ...
        >
          ...
          <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-white/45">
            {editingId ? "Edit payment" : "Log weekly payment"}
          </p>
